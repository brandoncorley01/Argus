...
4. Confirm Build shows **live-monitor-v2.50** (or newer). Also check Desktop `Argus-last-start.txt` says `GitHub sync: MATCH`.
...
3. Open http://127.0.0.1:3000/argus-build.txt (or `/api/argus-build`) — must say **live-monitor-v2.50**
...
4. Sign in and confirm Build **live-monitor-v2.50** (or newer)
