              ...
              <div className="attention-box" style={{ marginBottom: "0.75rem" }}>
                ...
                <p style={{ margin: "0.35rem 0 0" }}>
                  ...
                  {scorecard.organic_growth.net_vs_start != null
                    ...
                    : "—"}
                  , {scorecard.organic_growth.growth_pct ?? "0"}%). Cash available{" "}
                  {money(scorecard.organic_growth.cash_available)} (target{" "}
                  {money(scorecard.organic_growth.cash_reserve_target)}). Lane:{" "}
